        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SprintTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SprintDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SprintStartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SprintEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
